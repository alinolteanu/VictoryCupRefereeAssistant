...
public class GameSingleton {
    ...
    public List<Game> getAllGames() {
        ...
        teams.add(new Game(2, 1, 2, Game.LEAGUE_LIGA_2B, Game.PLAYING_FIELD_1, Game.GAME_NOT_STARTED, "20:00", null));
        teams.add(new Game(3, 3, 4, Game.LEAGUE_LIGA_2B, Game.PLAYING_FIELD_2, Game.GAME_IN_PROGRESS, "20:00", "2 - 0"));
        teams.add(new Game(4, 7, 8, Game.LEAGUE_LIGA_2B, Game.PLAYING_FIELD_2, Game.GAME_NOT_STARTED, "21:00", null));
